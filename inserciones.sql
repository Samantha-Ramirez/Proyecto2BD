...
INSERT INTO ProveedorProducto (id, proveedorId, productoId, fechaCompra, precioPor, cantidad) VALUES
    (1, 1, 1, '2023-10-26', 1.50, 200),
    (2, 2, 2, '2023-10-26', 2.00, 200),
    (3, 3, 3, '2023-10-25', 5.00, 200),
    (4, 4, 4, '2023-10-25', 1.00, 200),
    (5, 5, 5, '2023-10-24', 0.80, 200),
    (6, 6, 6, '2023-10-24', 3.00, 200),
    (7, 7, 7, '2023-10-23', 1.20, 200),
    (8, 8, 8, '2023-10-23', 2.50, 200),
    (9, 9, 9, '2023-10-22', 0.70, 200),
    (10, 10, 10, '2023-10-22', 4.00, 200),
    (11, 11, 1, '2023-10-21', 1.60, 200),
    (12, 12, 2, '2023-10-21', 2.10, 200),
    (13, 13, 3, '2023-10-20', 5.20, 200),
    (14, 14, 4, '2023-10-20', 1.10, 200),
    (15, 15, 5, '2023-10-19', 0.90, 200),
    (16, 16, 6, '2023-10-19', 3.20, 200),
    (17, 17, 7, '2023-10-18', 1.30, 200),
    (18, 18, 8, '2023-10-18', 2.60, 200),
    (19, 19, 9, '2023-10-17', 0.75, 200),
    (20, 20, 10, '2023-10-17', 4.10, 200),
    (21, 21, 3, '2023-10-16', 5.50, 200),
    (22, 22, 4, '2023-10-16', 1.20, 200),
    (23, 23, 5, '2023-10-15', 1.00, 200),
    (24, 24, 6, '2023-10-15', 3.50, 200),
    (25, 25, 7, '2023-10-14', 1.40, 200),
    (26, 26, 8, '2023-10-14', 2.80, 200),
    (27, 27, 9, '2023-10-13', 0.80, 200),
    (28, 28, 10, '2023-10-13', 4.20, 200),
    (29, 29, 1, '2023-10-12', 1.70, 200),
    (30, 30, 2, '2023-10-12', 2.20, 200),
    (31, 31, 3, '2023-10-11', 5.70, 200),
    (32, 32, 4, '2023-10-11', 1.30, 200),
    (33, 33, 5, '2023-10-10', 1.10, 200),
    (34, 34, 6, '2023-10-10', 3.70, 200),
    (35, 35, 7, '2023-10-09', 1.50, 200),
    (36, 36, 8, '2023-10-09', 3.00, 200),
    (37, 37, 9, '2023-10-08', 0.85, 200),
    (38, 38, 10, '2023-10-08', 4.30, 200),
    (39, 39, 1, '2023-10-07', 1.80, 200),
    (40, 40, 2, '2023-10-07', 2.30, 200),
    (41, 1, 6, '2023-10-06', 3.80, 200),
    (42, 2, 7, '2023-10-06', 1.60, 200),
    (43, 3, 8, '2023-10-05', 3.20, 200),
    (44, 4, 9, '2023-10-05', 0.90, 200),
    (45, 5, 10, '2023-10-04', 4.40, 200),
    (46, 6, 1, '2023-10-04', 1.90, 200),
    (47, 7, 2, '2023-10-03', 2.40, 200),
    (48, 8, 3, '2023-10-03', 6.00, 200),
    (49, 9, 4, '2023-10-02', 1.40, 200),
    (50, 10, 5, '2023-10-02', 1.20, 200),
    (51, 10, 12, '2023-10-02', 1.20, 200),
    (52, 10, 11, '2023-10-02', 1.20, 200),
    (53, 10, 13, '2023-10-02', 1.20, 200),
    (54, 10, 16, '2023-10-02', 1.20, 200),
    (55, 10, 20, '2023-10-02', 1.20, 200),
    (56, 10, 23, '2023-10-02', 1.20, 200),
    (57, 10, 15, '2023-10-02', 1.20, 200),
...
INSERT INTO Factura (id, fechaEmision, clienteId, subTotal, montoDescuentoTotal, porcentajeIVA, montoIVA, montoTotal) VALUES
    ...
    (101, '2025-06-02', 1, 100.00, 10.00, 16.00, 14.40, 104.40),
    (102, '2025-06-03', 1, 150.00, 15.00, 16.00, 21.60, 156.60),
    (103, '2025-06-04', 1, 90.00, 9.00, 16.00, 12.96, 93.96),
    (104, '2025-06-05', 1, 120.00, 12.00, 16.00, 17.28, 125.28), -- Física, con promo
